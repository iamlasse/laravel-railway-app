<x-guest-layout>
        <div class="relative flex justify-center min-h-screen py-4 items-top bg-telekom-darkblue dark:bg-gray-900 sm:items-center sm:pt-0">
            @if (Route::has('login'))
                <div class="fixed top-0 right-0 hidden px-6 py-4 sm:block">
                    @auth
                        @role('company-admin')
                        <a href="{{ route('admin.dashboard') }}" class="text-sm underline text-telekom-100 dark:text-gray-500">Admin</a>
                        @endrole
                        @role('company-user')
                        <a href="{{ route('company.dashboard') }}" class="text-sm underline text-telekom-100 dark:text-gray-500">Dashboard</a>
                        @endrole
                    @else
